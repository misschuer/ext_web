...
function _M:extend(hanlder)
	...
	hanlder['/world_xianfu/rank'] = self.rank --进行排名
	hanlder['/world_xianfu/check_rank'] = self.check_rank --更新排名
	hanlder['/world_xianfu/prepare_match'] = self.prepare_match --准备比赛
end
